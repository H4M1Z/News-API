...
class MoreButton extends StatelessWidget {
  ...
  static const _containerHeight = 0.66;
  //...PADDING VALUES
        ...
        return Center(
          child: Padding(
            padding: const EdgeInsets.only(
              right: _paddingFromRight,
              bottom: _paddingFromBottom,
            ),
            child: Container(
...
class RetryButton extends ConsumerWidget {
  ...
  //...SIZES
  static const _btnWidth = 0.23;
  static const _btnHeight = 0.05;
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final Size(:width, :height) = MediaQuery.sizeOf(context);
    return GestureDetector(
      onTap: ref.read(newsNotifierProvider.notifier).getHeadLineArticles,
      child: Container(
